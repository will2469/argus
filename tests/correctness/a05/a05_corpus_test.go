...
func parseAndInspect(t *testing.T, relPath string) ([]a05_audit_immutability.Issue, *token.FileSet) {
	t.Helper()
...
func TestA05_PositiveCorpus(t *testing.T) {
...
func TestA05_NegativeCorpus(t *testing.T) {
...
func TestA05_AdversarialCorpus(t *testing.T) {
...
func TestA05_StandaloneRunner_DualPathParity(t *testing.T) {
	...
	for _, iss := range res.Issues {
		if iss.Rule == "FORBIDDEN_AUDIT_MUTATION" {
			a05Issues++
		}
	}
	if a05Issues != 5 {
