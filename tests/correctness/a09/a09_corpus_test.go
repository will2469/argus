...
func TestA09_PositiveCorpus(t *testing.T) {
	...
	expectedLines := map[int]string{
		...
		41: "P4_Nested",
		48: "P5_Alias",
		54: "P6_BareHelperString",
		61: "P7_HardcodedResourceKey",
	}
...
func TestA09_StandaloneRunner_DualPathParity(t *testing.T) {
	...
	if a09Issues != 7 {
		t.Errorf("Dual-Path Parity FAILED on positive corpus: expected 7 issues from standalone runner, got %d", a09Issues)
	}
