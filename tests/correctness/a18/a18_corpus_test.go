...
func parseAndInspect(t *testing.T, relPath string) ([]a18_rows_err.Issue, *token.FileSet) {
	t.Helper()
	...
	issues := a18_rows_err.InspectFile(nil, fset, file, dm)
	return issues, fset
}

func TestA18_PositiveCorpus(t *testing.T) {
...
func TestA18_NegativeCorpus(t *testing.T) {
...
func TestA18_AdversarialCorpus(t *testing.T) {
	...
	assertions := []struct {
		...
		{"A1_Branch", 25, true},
		{"A2_Reassignment", 35, true},
		{"A3_Alias", 42, true},
		{"A4_Wrapper", 53, true},
		{"A5_NestedFunction", 60, true},
		{"A6_Generic", 73, true},
		{"A7_WrongVarCheck", 80, true},
	}
...
func TestA18_StandaloneRunner_DualPathParity(t *testing.T) {
	...
	for _, iss := range res.Issues {
		if iss.Rule == "MISSING_ROWS_ERR_CHECK" || iss.Rule == "ARGUS-A18" {
			a18Issues++
		}
	}
	if a18Issues == 0 {
